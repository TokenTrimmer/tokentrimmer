...
# License attribution: our own Apache-2.0 LICENSE + NOTICE and the bundled
# third-party crate licenses (generated by `scripts/gen-third-party-licenses.sh`
# / cargo-about). Many bundled deps (MIT/BSD/...) require their license text be
# reproduced in distributions, so the GHCR image must carry attribution.
COPY LICENSE NOTICE THIRD-PARTY-LICENSES /usr/local/share/doc/tt/
