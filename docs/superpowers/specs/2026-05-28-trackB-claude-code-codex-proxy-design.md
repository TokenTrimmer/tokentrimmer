...
**Status:** Superseded historical design — not an operational reference
**Track:** B of six-track expansion
**Date:** 2026-05-28

> This draft predates the released identity boundary and contains obsolete CLI flags, hybrid routing, and Codex compatibility assumptions. The authoritative contract is generated by `tt proxy --help` from `ModeContract` and documented in `docs/04-gateway-api-reference.md` §2.4. Current Codex CLI is not compatible with this proxy.
