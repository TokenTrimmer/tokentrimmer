...
-- route_pauses: gateway-owned sticky pause flags for down-routes whose paired
-- pass-rate regressed. Deliberately NO FK to routes: the routes table is
-- cloud-owned (tokentrimmer-cloud 0002) and absent on OSS deploys; public
...
-- sticky until an explicit resume deletes the row.
