...
/// Hard ceiling for tenant-owned L1 material. This bounds account-purge fence
/// lifetime and stays aligned with the longest Scale-tier cache window.
...
pub struct AppState {
    ...
    /// domain-separated `TT_MASTER_KEY` derivative.
