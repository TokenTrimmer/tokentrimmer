 ...
 *   5. Adds bounded, runtime-validated `gateway.models()` and
 *      `gateway.capabilities()` responder-metadata reads.
 *
 * @example
 *
 * ```ts
...
export class TokenTrimmer extends OpenAI {
  ...
  /** Bounded responder-scoped model and capability metadata reads. */
