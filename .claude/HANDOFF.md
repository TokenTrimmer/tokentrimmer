...
Continue converting tested server capability into reachable surface, then the dependency-ordered source queue. Keep root totals at 3 local complete / 42 partial / 11 external / 3 open (these advances deepen partial items but do not close them).
