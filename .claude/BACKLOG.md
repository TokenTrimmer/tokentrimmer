...
- [ ] [P2] [rv-ssrf-gemini-guard] rust-crate-builder: Apply tt_shared::url_guard::validate_provider_url to the Gemini adapter base_url (non-stream + stream) — rv-ssrf-url-guard covered compat/openai/anthropic but missed gemini; add allow_local test seam like the other native adapters (§5.2) (est: $0.30)
